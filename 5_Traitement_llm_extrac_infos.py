...
def configurer_chemins():
    ...
    dirs = {
        'source_dir': r"C:\Users\x\Desktop\NeuroPal_Global\Programmes\Modules\2_Neuropal_Traitement\0_Architecture_pipeline\03_Transcription",
        'history_dir': r"C:\Users\x\Desktop\NeuroPal_Global\Programmes\Modules\2_Neuropal_Traitement\0_Architecture_pipeline\04_Output_llm\history_llm",
        'output_dir': r"C:\Users\x\Desktop\NeuroPal_Global\Programmes\Modules\2_Neuropal_Traitement\0_Architecture_pipeline\04_Output_llm",
        'extract_history_dir': r"C:\Users\x\Desktop\NeuroPal_Global\Programmes\Modules\2_Neuropal_Traitement\0_Architecture_pipeline\04_Output_llm\history_llm"
    }
...
for filename in os.listdir(dirs['source_dir']):
    if filename not in already_processed and not filename.startswith('history'):
        ...
        history = [{"role": "system", "content": "You're a rigorous spy. Your role is to list the tasks and dates and evenements with dates. Number each element. Respond always in French."},
        ...
        with open(paths['output_file'], 'w', encoding='utf-8') as outfile:
            outfile.write("".join(new_message_content))
        print(f"La sortie pour {filename} a été enregistrée dans {paths['output_file']}.")
