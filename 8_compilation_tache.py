...
source_path = "C:/Users/x/Desktop/NeuroPal_Global/Base_de_donnees/3_Extraction_donnees/1_Extraction_task/Tâche.xlsx"
...
for row_index, row_data in enumerate(destination_ws.iter_rows(min_row=2, values_only=True), start=2):
    ...
    if cell_date in date_description_dict:
        ...
        initial_col = 5  # Colonne initiale pour les descriptions
